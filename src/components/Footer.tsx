        ...
        <div className="w-full max-w-[1240px] xl:max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-8 xl:gap-10 items-start">
            ...
            <div className="space-y-3.5">
              ...
              {/* 4 Circular Social Icons matching reference image */}
              <div className="flex items-center gap-2.5 pt-1">
                ...
                <a
                  ...
                  className="w-[34px] h-[34px] rounded-full bg-[#EBF0F5] hover:bg-[#1877F2]/15 text-[#1877F2] flex items-center justify-center transition-all duration-150 hover:scale-105"
                  title="Facebook"
                >
                ...
                <a
                  ...
                  className="w-[34px] h-[34px] rounded-full bg-[#EBF0F5] hover:bg-[#E4405F]/15 text-[#0077B5] hover:text-[#E4405F] flex items-center justify-center transition-all duration-150 hover:scale-105"
                  title="Instagram"
                >
                  <Instagram className="w-4 h-4 text-[#0077B5]" />
                </a>
                ...
                <a
                  ...
                  className="w-[34px] h-[34px] rounded-full bg-[#EBF0F5] hover:bg-[#FF0000]/15 text-[#FF0000] flex items-center justify-center transition-all duration-150 hover:scale-105"
                  title="YouTube"
                >
                  <Youtube className="w-4 h-4 fill-[#FF0000]" />
                </a>
                ...
                <a
                  ...
                  className="w-[34px] h-[34px] rounded-full bg-[#EBF0F5] hover:bg-[#25D366]/15 text-[#25D366] flex items-center justify-center transition-all duration-150 hover:scale-105"
                  title="WhatsApp"
                >
